...
function gerarRegras(): string {
  return [
    ...
    '      "tipo": "sinalizar",',
    '      "severidade": "baixa",',
    '      "justificativa": "A leitura automática não conseguiu interpretar o documento; isso não significa que o arquivo esteja ilegível para uma pessoa. É necessária conferência manual.",',
    '      "descricao": "Não foi possível ler este documento automaticamente. Confira você mesmo; se estiver legível, marque como verificado."',
    '    }',
    '  ]',
    '}',
    '',
