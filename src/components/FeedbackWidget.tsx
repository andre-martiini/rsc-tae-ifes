...
import { sendFeedback, processOfflineQueue, FeedbackPayload } from "../lib/feedbackService";
...
export default function FeedbackWidget() {
  ...
  return (
    <div
      ...
      className="fixed bottom-20 right-4 z-50 w-[340px] max-w-[calc(100vw-2rem)] rounded-2xl bg-white shadow-2xl ring-1 ring-gray-200 print:hidden"
    >
      {/* Header */}
      ...
      <div className="p-4">
        ...
        {/* Step: enviando */}
        {step === "sending" && (
          <div className="py-6 text-center text-sm text-gray-500">Enviando...</div>
        )}
