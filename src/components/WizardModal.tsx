...
const EIXOS: WizardEixo[] = [
  {
    ...
    itens: [
      ...
      { id: 'item-32', label: 'Atuação como responsável formal por setor ou unidade, formalmente designado.' },
      { id: 'item-33-t', label: 'Exercício de Cargo de Direção (CD-02) ou equivalente como titular.' },
      { id: 'item-33-s', label: 'Exercício de Cargo de Direção (CD-02) ou equivalente como substituto.' },
      { id: 'item-34-t', label: 'Exercício de Cargo de Direção (CD-03 e 04) ou equivalente como titular.' },
      { id: 'item-34-s', label: 'Exercício de Cargo de Direção (CD-03 e 04) ou equivalente como substituto.' },
      { id: 'item-35-t', label: 'Exercício de Função Gratificada (FG-01 e 02) ou equivalente como titular.' },
      { id: 'item-35-s', label: 'Exercício de Função Gratificada (FG-01 e 02) ou equivalente como substituto.' },
      { id: 'item-36-t', label: 'Exercício de Função Gratificada (a partir da FG-03) ou equivalente como titular.' },
      { id: 'item-36-s', label: 'Exercício de Função Gratificada (a partir da FG-03) ou equivalente como substituto.' },
    ],
  },
  {
    numero: 2,
  ...
  },
  {
    ...
    itens: [
      ...
      { id: 'item-21', label: 'Participação em capacitação, fórum, oficina, workshop e congresso, com carga horária mínima de dez horas, vinculada aos interesses da Instituição Federal de Ensino.' },
      ...
      { id: 'item-52', label: 'Atuação formalmente autorizada como instrutor, tutor, palestrante, autor de conteúdo técnico ou orientador em ação formativa estruturada de interesse institucional.' },
      { id: 'item-53', label: 'Atuação na coordenação de congresso, simpósio ou seminário de interesse institucional.' },
      { id: 'item-54', label: 'Exercício de atividade de coorientação de trabalho de conclusão de curso em diferentes modalidades de ensino.' },
    ],
  },
  {
    numero: 5,
    ...
    itens: [
      ...
      { id: 'item-43', label: 'Atuação em atividade de liderança ou vice-liderança de grupo de pesquisa ou extensão registrado em órgão ou sistema oficial de reconhecimento institucional.' },
  ...
  },
  {
    ...
    itens: [
      ...
      { id: 'item-56', label: 'Atuação institucional no enfrentamento de situações de surto, epidemia e pandemia. A pontuação é calculada em meses de atuação.' },
    ],
  },
];
